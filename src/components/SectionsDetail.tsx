...
const sections = [
  ...
  },
  {
    id: 'web-design',
    title: 'Web Design',
    subtitle: 'Design que Impacta',
    description: 'Criamos interfaces modernas e elegantes que conectam marcas ao futuro digital. Cada pixel é pensado para gerar impacto visual e uma experiência de navegação impecável.',
    details: [
      'Design Systems completos e escaláveis',
      'Prototipagem interativa em Figma',
      'UI/UX centrado no usuário com testes de usabilidade',
      'Identidade visual digital consistente',
    ],
  ...
  },
  {
    ...
    subtitle: 'Código de Excelência',
    description: 'Código limpo, performance máxima e arquitetura escalável. Utilizamos as tecnologias mais modernas do mercado para construir aplicações robustas e de alta qualidade.',
    details: [
      'Arquiteturas modernas com React, Next.js e TypeScript',
      'APIs REST e GraphQL com Node.js e Python',
      'Bancos de dados PostgreSQL, MongoDB e Redis',
      'CI/CD, testes automatizados e deploy contínuo',
    ],
  ...
  },
  {
    ...
    subtitle: 'Animações & Interações',
    description: 'Design centrado no usuário com estética cinematográfica e animações fluidas. Transformamos interfaces comuns em experiências memoráveis com micro-interações e transições impactantes.',
    details: [
      'Animações com GSAP, Framer Motion e Three.js',
      'Efeitos visuais WebGL e shaders customizados',
      'Transições de página cinematográficas',
      'Design responsivo com atenção a cada breakpoint',
    ],
  ...
  },
  {
    ...
    description: 'Integramos inteligência artificial e tecnologias emergentes para criar soluções que fazem a diferença. Do conceito à produção, levamos inovação para cada projeto.',
    details: [
      'Integração com modelos de IA e Machine Learning',
      'Automação inteligente de processos',
      'Infraestrutura cloud com AWS e Google Cloud',
  ...
  },
  {
    ...
    description: 'Aplicações responsivas e multiplataforma que funcionam perfeitamente em qualquer dispositivo. Do mobile ao desktop, garantimos uma experiência consistente e fluida.',
    details: [
