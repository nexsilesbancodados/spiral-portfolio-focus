...
class AnimationController {
    ...
    // expose for Star access
    public get _cameraZ() { return this.cameraZ }
    public get _viewZoom() { return this.viewZoom }
}
...
class Star {
    ...
    constructor(cameraZ: number, cameraTravelDistance: number) {
        ...
        this.z = this.z * 0.7 + (cameraTravelDistance / 2) * 0.3 * this.spiralLocation + this.z * (1 - 0.3 * this.spiralLocation)
...
export function SpiralAnimation() {
    ...
    useEffect(() => {
        ...
        if (!canvas || dimensions.width === 0 || typeof gsap === 'undefined') return
