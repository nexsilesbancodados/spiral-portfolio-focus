...
const slides = [
  ...
  { title: "Serviços", description: "Soluções digitais completas — tráfego pago, sites, apps, SaaS e design premium.", media: "/videos/servicos.mp4", skills: ["Tráfego Pago", "Sites", "Apps", "SaaS"] },
