...
const slides = [
  ...
  { title: "Serviços", description: "Soluções digitais completas — tráfego pago, sites, apps, SaaS e design premium.", media: "/images/slide-04.jpg", skills: ["Tráfego Pago", "Sites", "Apps", "SaaS"] },
