...
const Intro = () => {
  ...
  useEffect(() => {
    ...
    const tick = (now: number) => {
      ...
      const next = Math.min((elapsed / totalMs) * 100, 100);
      setProgress(next);
  ...
  return (
    <div
      className={`fixed inset-0 z-[9999] bg-background flex flex-col items-center justify-end transition-opacity duration-300 ${
